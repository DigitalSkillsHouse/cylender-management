 ...
 */
const getDubaiDateComponents = (date) => {
 ...
 */
export const getStartOfDate = (dateString) => {
  if (!dateString) {
 ...
 */
export const getEndOfDate = (dateString) => {
  if (!dateString) {
 ...
 */
export const getDateRangeForPeriod = (fromDate, toDate) => ({
 ...
 */
export const getDateFromString = (dateString) => getStartOfDate(dateString)

/**
 * Get current Dubai time as ISO string
 * @returns {string} ISO string of current time in Dubai timezone
 */
export const getDubaiNowISOString = () => {
  const now = new Date()
 ...
 */
export const formatDubaiDate = (date, options = {}) => {
  const dateObj = date instanceof Date ? date : new Date(date)
 ...
 */
export const getDubaiDateTimeString = (date = null) => {
 ...
 * @returns {string} Formatted date string
 */
export const getDubaiDateDisplayString = (date = null) => {
  const dateObj = date ? (date instanceof Date ? date : new Date(date)) : new Date()
  return formatDubaiDate(dateObj, {
    year: 'numeric',
    month: '2-digit',
 ...
 */
export const getPreviousDate = (dateString = null) => addDaysToDate(dateString || getLocalDateString(), -1)
 ...
 */
export const getNextDate = (dateString = null) => addDaysToDate(dateString || getLocalDateString(), 1)
 ...
 */
export const isToday = (dateString) => dateString === getLocalDateString()
