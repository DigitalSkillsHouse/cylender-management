        ...
        const itemsNormalized = (saved?.items && Array.isArray(saved.items) && saved.items.length > 0)
          ? saved.items.map((it: any) => {
              ...
              return { 
                ...
                cylinderStatus: (it.cylinderStatus || product?.cylinderStatus) as "empty" | "full" | undefined
              }
            })
          : (formData.items || []).map((it: any) => {
              ...
              return { 
                ...
                cylinderStatus: (it.cylinderStatus || p?.cylinderStatus) as "empty" | "full" | undefined
              }
            })
